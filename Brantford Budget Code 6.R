...
Brantford_Budget_Survey_Cleaned %>% 
  select(Satisfaction, Edu_4, Gender_Cat2) %>% 
  pivot_longer(., cols=Satisfaction) %>% 
  group_by(Edu_4, name, Gender_Cat2) %>% 
  filter(Edu_4!=".") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=Edu_4, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Not Satisfied","2","3","4","5","6","7","8","9","Very Satisfied"))+
...
#Satisfaction by Age
Brantford_Budget_Survey_Cleaned %>% 
  select(Satisfaction, Age_4, Gender_Cat2) %>% 
  pivot_longer(., cols=Satisfaction) %>% 
  group_by(Age_4, name, Gender_Cat2) %>% 
  filter(Age_4!=".") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=Age_4, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Not Satisfied","2","3","4","5","6","7","8","9","Very Satisfied"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
#Satisfaction by FSA
Brantford_Budget_Survey_Cleaned %>% 
  select(Satisfaction, FSA, Gender_Cat2) %>% 
  pivot_longer(., cols=Satisfaction) %>% 
  group_by(FSA, name, Gender_Cat2) %>% 
  filter(FSA!=".") %>%
  filter(FSA!="N4T") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=FSA, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Not Satisfied","2","3","4","5","6","7","8","9","Very Satisfied"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
#Value by Education
Brantford_Budget_Survey_Cleaned %>% 
  select(Value, Edu_4, Gender_Cat2) %>% 
  pivot_longer(., cols=Value) %>% 
  group_by(Edu_4, name, Gender_Cat2) %>% 
  filter(Edu_4!=".") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=Edu_4, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Very Good","Fairly Good","Fairly Poor","Very Poor"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
#Value by Age
Brantford_Budget_Survey_Cleaned %>% 
  select(Value, Age_4, Gender_Cat2) %>% 
  pivot_longer(., cols=Value) %>% 
  group_by(Age_4, name, Gender_Cat2) %>% 
  filter(Age_4!=".") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=Age_4, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Very Good","Fairly Good","Fairly Poor","Very Poor"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
Brantford_Budget_Survey_Cleaned %>% 
  ...
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=FSA, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Very Good","Fairly Good","Fairly Poor","Very Poor"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
Brantford_Budget_Survey_Cleaned %>% 
  ...
  labs(y="", x="", title=str_wrap("Key Programming/Services", width =60))+
  guides(fill=guide_legend(title="", reverse = TRUE))+
...
Brantford_Budget_Survey_Cleaned %>% 
  select(SA_Police:SA_Storm, Gender_Cat2) %>% 
  pivot_longer(., cols=-Gender_Cat2) %>% 
  group_by(Gender_Cat2, name) %>% 
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=name, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Significantly\n Reduce","","Maintain","","Significantly \n Increase"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
  scale_y_discrete(labels = c("Children's Services", "Economic Development", "Facilities Management and Security", "Brantford Fire", "Garbage and Recycling", "Housing", "John Noble Home", "Brantford-Brant Paramedics", "Parks, Sports Fields \n& Recreational Programming", "Brant County Public Health Unit", "Brantford Police", "Public Works Operational Services", "Social Assistance and Homelessness", "Storm Water Management", "Tourism and Culture", "Brantford Transit" ))+
...
Brantford_Budget_Survey_Cleaned %>% 
  ...
  theme(legend.position="bottom",legend.text=element_text(size=10))+
  scale_color_manual(values = c("Primary" = "#F8766D", "Secondary" = "#00BFC4", "Post-Secondary"="#7CAE00", "Graduate/Professional"="#C77CFF"))
...
Brantford_Budget_Survey_Cleaned %>% 
  ...
  filter(Age_4!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=name, col=as.factor(Age_4))) + geom_point(size = 2)+xlim(c("Significantly\n Reduce","","Maintain","","Significantly \n Increase"))+
  #geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
  scale_y_discrete(labels = c("Children's Services", "Economic Development", "Facilities Management and Security", "Brantford Fire", "Garbage and Recycling", "Housing", "John Noble Home", "Brantford-Brant Paramedics", "Parks, Sports Fields \n& Recreational Programming", "Brant County Public Health Unit", "Brantford Police", "Public Works Operational Services", "Social Assistance and Homelessness", "Storm Water Management", "Tourism and Culture", "Brantford Transit" ))+
  labs(y="", x="", title=str_wrap("Key Programming/Services by Age Group", width =60))+
  guides(color=guide_legend(""))+
  theme(legend.position="bottom",legend.text=element_text(size=10))+
  scale_color_discrete(labels = c("Under 35","35-49","50-64", "65 and Over"))
...
Brantford_Budget_Survey_Cleaned %>% 
  select(Fee_Parks:Fee_Roads, Gender_Cat2) %>% 
  pivot_longer(., cols=-Gender_Cat2) %>% 
  group_by(Gender_Cat2, name) %>% 
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=name, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Significantly Support", "Somewhat Support", "Somewhat Oppose", "Significantly Oppose"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
  scale_y_discrete(labels = c("Parking Lots", "Access to Park and Recreation Facilities", "New Development Applications", "Use of Roads", "Street Parking", "Brantford Transit and Lift"))+
...
Brantford_Budget_Survey_Cleaned %>% 
  ...
  guides(color=guide_legend(""))+
  theme(legend.position="bottom",legend.text=element_text(size=10))+
  scale_color_manual(values = c("Primary" = "#F8766D", "Secondary" = "#7CAE00", "Post-Secondary"="#00BFC4", "Graduate/Professional"="#C77CFF"))
...
Brantford_Budget_Survey_Cleaned %>% 
  ...
  filter(Age_4!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=name, col=as.factor(Age_4))) + geom_point(size = 2)+xlim(c("Significantly Support", "Somewhat Support", "Somewhat Oppose", "Significantly Oppose"))+
  #geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
  scale_y_discrete(labels = c("Parking Lots", "Access to Park and Recreation Facilities", "New Development Applications", "Use of Roads", "Street Parking", "Brantford Transit and Lift"))+
  labs(y="", x="", title=str_wrap("Do you support an increase or new user fees for the following areas:", width =80))+
  guides(color=guide_legend(""))+
...
Brantford_Budget_Survey_Cleaned %>% 
  select(Opt_Airport:Opt_Special, Gender_Cat2) %>% 
  pivot_longer(., cols=-Gender_Cat2) %>% 
  group_by(Gender_Cat2, name) %>% 
  filter(Gender_Cat2!=".") %>%
  filter(value!=".") %>%
...
Brantford_Budget_Survey_Cleaned %>% 
  select(Infrastructure, Edu_4, Gender_Cat2) %>% 
  pivot_longer(., cols=Infrastructure) %>% 
  group_by(Edu_4, name, Gender_Cat2) %>% 
  filter(Edu_4!=".") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=Edu_4, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Spend on Infrastructure Now", "Not Sure",  "Defer Maintenance"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
Brantford_Budget_Survey_Cleaned %>% 
  select(Infrastructure, FSA, Gender_Cat2) %>% 
  pivot_longer(., cols=Infrastructure) %>% 
  group_by(FSA, name, Gender_Cat2) %>% 
  filter(FSA!=".") %>%
  filter(FSA!="N4T") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=FSA, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Spend on Infrastructure Now", "Not Sure",  "Defer Maintenance"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
Brantford_Budget_Survey_Cleaned %>% 
  select(Infrastructure, Age_4, Gender_Cat2) %>% 
  pivot_longer(., cols=Infrastructure) %>% 
  group_by(Age_4, name, Gender_Cat2) %>% 
  filter(Age_4!=".") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=Age_4, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Spend on Infrastructure Now", "Not Sure",  "Defer Maintenance"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
Brantford_Budget_Survey_Cleaned %>% 
  select(Maintain, Edu_4, Gender_Cat2) %>% 
  pivot_longer(., cols=Maintain) %>% 
  group_by(Edu_4, name, Gender_Cat2) %>% 
  filter(Edu_4!=".") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=Edu_4, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Increase Taxes Significantly \nto Expand Services", "Increase Taxes Slightly \n to Maintain Service Levels",  "Maintain Taxes by Cutting \n Some Services", "Reduce Taxes by Significantly \n Cutting Services"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
Brantford_Budget_Survey_Cleaned %>% 
  select(Maintain, Age_4, Gender_Cat2) %>% 
  pivot_longer(., cols=Maintain) %>% 
  group_by(Age_4, name, Gender_Cat2) %>% 
  filter(Age_4!=".") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=Age_4, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Increase Taxes Significantly \nto Expand Services", "Increase Taxes Slightly \n to Maintain Service Levels",  "Maintain Taxes by Cutting \n Some Services", "Reduce Taxes by Significantly \n Cutting Services"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
...
Brantford_Budget_Survey_Cleaned %>% 
  select(Maintain, FSA, Gender_Cat2) %>% 
  pivot_longer(., cols=Maintain) %>% 
  group_by(FSA, name, Gender_Cat2) %>% 
  filter(FSA!=".") %>%
  filter(FSA!="N4T") %>%
  filter(Gender_Cat2!=".") %>%
  summarize(average=mean((value), na.rm=TRUE), sd=sd((value), na.rm=TRUE), n=n(), se=sd/sqrt(n)) %>% 
  ggplot(., aes(x=average, y=FSA, col=Gender_Cat2)) + geom_point(size = 2)+xlim(c("Increase Taxes Significantly \nto Expand Services", "Increase Taxes Slightly \n to Maintain Service Levels",  "Maintain Taxes by Cutting \n Some Services", "Reduce Taxes by Significantly \n Cutting Services"))+
  geom_errorbar(aes(xmin=average-(1.96*se), xmax=average+(1.96*se)), width=0)+
